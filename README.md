...
#### Many object detection methods with deep learning achieved excellent performance to identify objects in images. However, whether they will work to detect visual signals to help diagnose diseases in medical images is still under explored. 

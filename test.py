...
from generator import PatientInfo, AugmentedLabelSequence
...
def main():
    ...
    Xid_test, _ = test_ids.split(test_size=0)
    
    test_sequence = AugmentedLabelSequence(
        'stage_1_test_images/', 
        Xid_test, y=None,
        img_format='.dcm',
    ...
    #return model, Xid_test, test_sequence
    ...
    pickle.dump(y_hat, open( test_log_path, "wb" ) )
